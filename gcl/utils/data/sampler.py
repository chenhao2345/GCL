    ...
    def __iter__(self):
        ...
        for kid in indices:
            ...
            if select_cams:
                ...
                if len(index) >= self.num_instances:
                    t = np.random.choice(index, size=self.num_instances, replace=False)
                else:
                    t = np.random.choice(index, size=self.num_instances, replace=True)
                ret.extend(t)
